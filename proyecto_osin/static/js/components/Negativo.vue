...
<template>
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <form v-on:submit.prevent="createPositivo()">
          ...
          <div class="form-group">
            <button class="btn btn-raised btn-primary" type="submit" id="envionega">
    ...
    <div id="myModalNe" class="modal fade" role="dialog">
...
export default {
  ...
  methods: {
    ...
    infopersona(info) {
      ...
      $("#myModalNe").modal("show");
    },
    editPositivo(info) {
      //var selfx = this;
      let url_edit = "http://127.0.0.1:8000/persona/editnegativo/" + info + "/";
      var dataedit = {
    ...
    deletepersona(info) {
      let url_delete =
        "http://127.0.0.1:8000/persona/deletenegativo/" + info.id;
      var selfdel = this;
      swal({
        title: "Estas seguro?",
    ...
    createPositivo() {
      ...
      axios
        .post("http://127.0.0.1:8000/persona/addnegativo", data, config)
        .then(response => {
