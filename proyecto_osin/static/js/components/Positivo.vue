    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <form v-on:submit.prevent="createPositivo()">
          ...
          <div class="form-group">
            <button class="btn btn-raised btn-primary" type="submit" id="envio">
...
export default {
  ...
  methods: {
    ...
    editPositivo(info) {
      //var selfx = this;
      let url_edit = "http://127.0.0.1:8000/persona/editpositivo/" + info + "/";
      var dataedit = {
    ...
    deletepersona(info) {
      let url_delete =
        "http://127.0.0.1:8000/persona/deletepositivo/" + info.id;
      var selfdel = this;
      swal({
        title: "Estas seguro?",
    ...
    createPositivo() {
      ...
      axios
        .post("http://127.0.0.1:8000/persona/addpositivo", data, config)
        .then(response => {
