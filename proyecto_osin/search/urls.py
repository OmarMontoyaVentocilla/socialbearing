...
from .views import create_auto, list_auto, update_auto, delete_auto, getAuto, customSearch, get_details, gettw, gethit, getinsta, getgoogle, getcomercio, getsocial, getsocialUser ,createfacebook, createtw, creategit, createasig, creategoogle, getinstadet, createinstagram, gettrending
...
urlpatterns = [
         ...
         path('getsocial', getsocial,name='getsocial'),
         path('getsocialUser',getsocialUser,name='getsocialUser'),
